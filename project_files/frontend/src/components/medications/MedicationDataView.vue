<template>
    <div class="card">
      <DataView :value="props.medications" :layout="layout" :sortOrder="sortOrder" :sortField="sortField">
        <template #header>
        ...
        <template #list="slotProps">
          <div class="flex flex-col w-full">
            <div v-for="(medication, index) in slotProps.items" :key="medication.id" class="w-full mb-4">
              <div
                  ...
                  <div class="grid grid-cols-2 gap-x-4 gap-y-3">
                    <div class="col-span-2">
                      ...
                      <div class="flex gap-2 mt-0.5 justify-between">
                        <p class="text-base font-semibold text-surface-900 dark:text-surface-0">{{ medication.name }}</p>
                        <div class="flex flex-row gap-1">
                          <Tag :value="medication.form" rounded severity="info" class="text-sm"></Tag>
                          <Tag :value="medication.route" rounded severity="info" class="text-sm"></Tag>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p class="text-base text-surface-900 dark:text-surface-0 mt-0.5">{{ medication.dosage }}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p class="text-base text-surface-900 dark:text-surface-0 mt-0.5">
                        ...
                        <span v-if="medication.time_of_day" class="text-sm">({{ medication.time_of_day }})</span>
                      </p>
                    </div>
