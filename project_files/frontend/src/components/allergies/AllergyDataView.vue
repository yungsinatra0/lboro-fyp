<template>
    <div class="card w-full h-full">
      <DataView :value="props.allergies" :layout="layout" :sortOrder="sortOrder" :sortField="sortField">
        <template #header>
                ...
                <div class="p-4">
                  <div class="grid grid-cols-2 gap-x-4 gap-y-3">
                    ...
                    <div>
                      ...
                      <div class="mt-0.5">
                        <Tag :value="allergy.severity" :severity="getSeverityType(allergy.severity)" rounded />
                      </div>
                    </div>
  ...
  const sortOptions = ref([
    ...
    { label: 'Severitate', value: 'severity' },
  ])
