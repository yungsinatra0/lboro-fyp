...
\begin{figure}[ht]
    \centering
    \subfloat[Desktop version]{\includegraphics[width=0.75\textwidth]{wireframes/Desktop_dashboard.png}\label{fig:dashboard-desktop}} 
    \hspace{0.05\textwidth} 
    \subfloat[Mobile version]{\includegraphics[scale=0.3]{wireframes/Mobile_dashboard.png}\label{fig:dashboard-mobile}} 
...
\begin{figure}[ht]
    \centering
    \subfloat[Desktop version]{\includegraphics[width=0.75\textwidth]{wireframes/Desktop_medHistory.png}\label{fig:medhistory-desktop}} 
    \hspace{0.05\textwidth} 
    \subfloat[Mobile version]{\includegraphics[scale=0.3]{wireframes/Mobile_medHistory.png}\label{fig:medhistory-mobile}} 
...
\begin{figure}[ht]
    \centering
    \subfloat[Desktop version]{\includegraphics[width=0.75\textwidth]{wireframes/Desktop_labTest.png}\label{fig:lab-desktop}}
    \hspace{0.05\textwidth} 
    \subfloat[Mobile version]{\includegraphics[scale=0.3]{wireframes/Mobile_labTest.png}\label{fig:lab-mobile}} 
