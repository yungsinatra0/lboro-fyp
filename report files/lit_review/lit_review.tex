...
\begin{table}[h!]
    ...
    \begin{tabular}{p{3cm} p{8cm} p{2cm}}
        ...
        \hline
        \raggedright
        Prompt Mining & Scanning the large corpus of training data to discover common prompt formats that can be used to write better prompts the model might be more familiar with. & \textcite{mining} \\
        \bottomrule
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{p{3cm} p{8cm} p{2cm}}
        ...
        \hline
        \raggedright
        ReAct & Firstly, the model generates a thought based on the input. Then, the model takes an action and observes the result. This process is repeated until the model arrives at an answer. & \textcite{react} \\
        \hline
        \raggedright
